    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">{{trans('playlists.new')}}</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{route('admin.playlists.store')}}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('public') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <select id="public" name="public" class="selectpicker">
                                    <option value="Y">{{trans('playlists.status.true')}}</option>
                                    <option value="N">{{trans('playlists.status.false')}}</option>
                                </select>
