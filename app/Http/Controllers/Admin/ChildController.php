...
class ChildController extends Controller implements IController
{
    ...
    public function index()
    {
        ...
        return view('admin/children/index')->with('children', $children);
    }
    ...
    public function show($id)
    {
        ...
        if ($this->isAllowed($child)) return view('admin/children/show')->with('child', $child);
        throw new AuthorizationException();
    }
    ...
    {
        $child = $this->getData($id);
        if ($this->isAllowed($child)) return view('admin/children/edit')->with('child', $child);
        throw new AuthorizationException();
    }
